...
import { WA_NUMBER, PAYMENT_METHODS, buildWhatsAppMessage } from '../utils/whatsapp.jsx';
...
function Chatbot({ cartItems = [] }) {
  ...
  const sendWhatsApp = () => {
    const msg = buildWhatsAppMessage(cartItems, orderData, '_Pedido enviado desde Berakah Boutique 🌿_');
